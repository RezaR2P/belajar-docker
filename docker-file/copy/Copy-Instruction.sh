...
# docker copy
docker build -t chelixx/copy copy
docker container create --name chelixxcopy chelixx/copy
docker container start chelixxcopy
docker container logs chelixxcopy